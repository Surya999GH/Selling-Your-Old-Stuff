...
{
if((Email.equals(cemail))&&Pwd.equals(cpwd))
{
    int j=0;
...
{
  %>
  <h1>Product Sold Successful...</h1>
  <%
  out.print("Your Product Id is "+IId);

}
else{
    %>
    <h1>Product Selling Unsuccessful???</h1><br>
    <%
    ...
    %>
    <h1>Incorrect Password or Email?Please check and try again.</h1>
    <%
}
}
else{
...
%>
<form method="POST" action="http://localhost:3886/Surendra/SellProduct.jsp">
<div style="text-align: left;width: 450px;height: auto;margin: 0 auto;">
   <br><br><br><br><br> 
   <label for="cemail">Confirm Email:</label>
   <input name="cemail" id="cemail" required>
   <br><br>
   <label for="cpassword">Confirm Password:</label>
   <input name="cpassword" id="cpassword" required>
   <br><br>
  <label for="ItemName">Item Name:</label>
    <input  name="ItemName" id="ItemName" required>
    <!-- <br><br>
    <label for="ItemId"> Give Item Id</label>
    ...
    <br><br>
    <label for="Price">Estimated Price in rupees:</label>
    <input name="Price" id="Price" type="number" required>
    <br><br>
    <button type="submit" style="background-color: rgb(72, 116, 235); color:white;">Sell Product</button>
</div>
</form>
</div>
</body></html>