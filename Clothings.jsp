...
<div class="navbar">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      ...
      <a href="http://localhost:3886/Surendra/HouseHolds.jsp">HouseHolds</a>
...
<div style="height: 100%;width: 100%;float: left;">
  ...
  <input type="hidden" name="Cost" value="<%= Price%>">
   <button type="submit" onclick="Add()">Add To Cart</button></form>&nbsp;&nbsp;<br><br><form method="POST" action="http://localhost:3886/Surendra/Buy.jsp">
    <input type="hidden" name="ItemName" value="<%=IName%>">
    <input type="hidden" name="ItemId" value="<%= Id%>" >
    <input type="hidden" name="Cost" value="<%= Price%>">
